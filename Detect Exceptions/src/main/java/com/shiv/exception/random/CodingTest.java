...
//        out.println(UUID.randomUUID());
        ...
        Date date=simpleDateFormat.parse("2023-12-13 00:00:00");
        out.println(date);
        out.println(date.getTime());
        out.println(new Date(1702425600000L));
        out.println(simpleDateFormat.format(new Date(1702425600000L)));
        out.println(Timestamp.valueOf("2023-12-13 00:00:00").getTime());
    }
}
